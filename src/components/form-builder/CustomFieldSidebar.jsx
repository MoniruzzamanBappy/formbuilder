...
function DraggableCustomField({ field, renderIcon }) {
  ...
  return (
    <div
      className={`bg-white rounded-lg mb-2 border border-neutral-200 p-3 flex items-center justify-between cursor-move hover:border-neutral-300 shadow-sm ${
