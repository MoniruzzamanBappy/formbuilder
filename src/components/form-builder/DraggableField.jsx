...
export default function DraggableField({ field, fieldsetId }) {
  ...
  return (
    <div
      ref={fieldRef}
      className={`field-item border ${
        isSelected ? "border-blue-600 border-2" : "border-neutral-100"
      } 
    ...
    case "date":
      return (
        <div className="w-full px-3 py-2 border border-neutral-300 rounded-md bg-white text-sm text-neutral-500 flex justify-between items-center">
          ...
          >
            <path
              d="M3.5 2.5V4.5M11.5 2.5V4.5M2.5 7H12.5M2.5 5.5C2.5 4.94772 2.94772 4.5 3.5 4.5H11.5C12.0523 4.5 12.5 4.94772 12.5 5.5V11.5C12.5 12.0523 12.0523 12.5 11.5 12.5H3.5C2.94772 12.5 2.5 12.0523 2.5 11.5V5.5Z"
              stroke="currentColor"
              strokeWidth="1.5"
              strokeLinecap="round"
              strokeLinejoin="round"
